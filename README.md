...
como: Banco de dados, Interface, Arquiterura e Segurança. Mas não pretendo que este seja um grande projeto, é apenas para treinar meus conhecimentos na linguagem Python.
